  ...
  <div className="flex flex-col items-center min-h-screen bg-gray-900 text-center">
    ...
    <main className="flex flex-col items-center p-8">
      <form className="bg-white p-6 shadow-md rounded w-full max-w-md">
        ...
        <p className="mb-2">Digite seu e-mail para enviarmos o código de verificação.</p>
        <input type="email" placeholder="E-Mail" className="border p-2 w-full mb-4" />
        <button className="btn-cheetah text-white px-4 py-2 w-full">Enviar</button>
        <div className="mt-4 text-center">
          <Link to="/login" className="text-blue-500 block mt-4">Voltar para a tela de login</Link>
        </div>
      </form>
    </main>
  </div>
